...
def carga_selector_moto():
    #moto = ['ENDURO RR 125 2T MY21','ENDURO RR 125 2T MY22','ENDURO RR 200 2T MY21','ENDURO RR 200 2T MY22','ENDURO RR 250 2T MY21','ENDURO RR 250 2T MY22','ENDURO RR 300 2T MY21','ENDURO RR 300 2T MY22','ENDURO RR 350 4T MY21','ENDURO RR 350 4T MY22','ENDURO RR 390 4T MY21','ENDURO RR 390 4T MY22','ENDURO RR 430 4T MY21','ENDURO RR 430 4T MY22','ENDURO RR 480 4T MY21','ENDURO RR 480 4T MY22','ENDURO XTRAINER 250 2T MY21','ENDURO XTRAINER 250 2T MY21 JP','ENDURO XTRAINER 250 2T MY22','ENDURO XTRAINER 300 2T MY21','ENDURO XTRAINER 300 2T MY22']
    moto = ['ENDURO RR 480 4T MY22','ENDURO XTRAINER 300 2T MY22','ENDURO XTRAINER 250 2T MY21']
    return moto

def despiece_beta(driver,moto,componente):
    titulo = moto
    time.sleep(3)
    ...
    add_word(moto, titulo+'.docx', fichero+'.png', tabla)
    time.sleep(1)
    return tabla[1]
...
def inicio_beta():
    ...
    for moto in motos:
        ...
        for componente in range (repeticiones):
            ...
            time.sleep(10)
            v_temp_df_moto = despiece_beta(driver, v_moto, componente)
